...
router.get("/views/product/:categoria", mainController.categoria);    //catalogo homeRoutes

// Ruta para ver el detalle del producto seleccionado
router.get("/views/productDetail/:codigo", mainController.productDetail);   //details homeRoutes
